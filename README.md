...
> **Note:** This is a fork of [QuentinFuxa/WhisperLiveKit](https://github.com/QuentinFuxa/WhisperLiveKit) with minor changes.
...
_The backend supports multiple concurrent users. Voice Activity Detection reduces overhead when no voice is detected._
...
| OpenAI API                                         | `openai`                                                            |
| _[Not recommanded]_ Speaker diarization with Diart | `diart`                                                             |
